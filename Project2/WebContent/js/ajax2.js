// <ajax2.js> -> ajax.doc문서 21페이지에서 복사해옴
var ajax = {};
...
ajax.xhr.Request.prototype = {
	...
	send: function() {
		...
		var request = this; // request : ajax.xhr객체 (현재 클래스를 레퍼런스)
		this.req.onreadystatechange = function() {// callback (XMLHttpRequest객체의 readyState값이 바뀔 때) 
