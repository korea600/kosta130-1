		...
		<header style="position:fiexd;,top:0;,left:0;">
			...
			<nav>
				<ul>
					...
					<li>이름 :</li>
					<li>${LoginDTO.name }</li>
					<li><a href="#" onclick="window.open('/Project2/common/pw_check.jsp','개인정보수정','width=360,height=240,menubar=no,status=no,toolbar=no,resizable=no,left=350,top=350');">정보수정</a></li>
